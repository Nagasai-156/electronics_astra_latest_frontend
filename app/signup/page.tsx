          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-200px)]">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <span className="text-sm font-black text-black">Welcome to Electronics Astra</span>
                </motion.div>
                
                <h1 className="text-5xl font-display font-black text-primary-500 mb-4 leading-tight">
                  Shape the Future of 
                  <span className="text-secondary-500"> Electronics</span>
                </h1>
                
                <p className="text-lg text-gray-700 font-semibold leading-relaxed mb-8">
                  Join thousands of engineers mastering the technologies that power tomorrow's world. 
                  From IoT devices to autonomous vehicles, electronics engineering is at the heart of innovation.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Smartphone, title: 'Mobile Tech', desc: 'Next-gen devices' },
                  { icon: Car, title: 'Automotive', desc: 'Smart vehicles' },
                  { icon: Home, title: 'Smart Homes', desc: 'IoT solutions' },
                  { icon: Rocket, title: 'Aerospace', desc: 'Space technology' }
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
              ...
              >
                <h3 className="text-white font-black text-lg mb-4">Join Our Growing Community</h3>
                <div className="grid grid-cols-3 gap-4">
                  {[
                    { icon: Users, value: '15K+', label: 'Engineers' },
            ...
            >
              <div className="text-center mb-6">
                <h2 className="text-2xl font-display font-black text-primary-500 mb-2">Create Account</h2>
                <p className="text-gray-600 font-semibold">Join the electronics revolution</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-sm font-black text-black mb-2">First Name</label>
                  ...
                  <div>
                    <label className="block text-sm font-black text-black mb-2">Last Name</label>
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                      <input
                        type="text"
                    ...
                    <div className="mt-2">
                      <div className="flex gap-1 mb-1">
                        {[1, 2, 3, 4, 5].map((level) => (
                          <div
                            key={level}
                            className={`h-1.5 flex-1 rounded-full border border-black ${
                              level <= passwordStrength
                                ? level <= 2 ? 'bg-red-400' : level <= 3 ? 'bg-yellow-400' : level <= 4 ? 'bg-secondary-400' : 'bg-green-400'
                                : 'bg-gray-200'
                            }`}
                          />
                        ))}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className={`w-full pl-10 pr-10 py-3 bg-gray-50 text-black rounded-xl focus:outline-none focus:ring-3 border-2 font-semibold transition-all placeholder:text-gray-500 ${
                        formData.confirmPassword === '' ? 'border-black focus:ring-primary-300' :
                        passwordsMatch ? 'border-green-500 focus:ring-green-300' : 'border-red-500 focus:ring-red-300'
                      }`}
                      required
                    />
                    <button
                ...
                <div className="flex items-start gap-3 pt-2">
                  <input
                    ...
                    className="w-4 h-4 mt-0.5 accent-primary-500 cursor-pointer border-2 border-black rounded"
                    required
                  />
                  <label htmlFor="terms" className="text-xs text-gray-700 font-semibold cursor-pointer">
                    I agree to the{' '}
                    <Link href="/terms" className="text-primary-500 hover:text-secondary-500 font-black transition-colors">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link href="/privacy" className="text-primary-500 hover:text-secondary-500 font-black transition-colors">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
              ...
              <div className="text-center mt-6">
                <p className="text-gray-600 font-semibold text-sm">
                  ...
                  <Link href="/signin" className="text-primary-500 hover:text-secondary-500 font-black transition-colors inline-flex items-center gap-1 group">
                    Sign In
